...
import '../form_managers/hereditary_disease_form_manager.dart';
...
class AddHereditaryDiseaseScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: const _AddHereditaryDiseaseView(),
    );
  }
}

class _AddHereditaryDiseaseView extends StatefulWidget {
  const _AddHereditaryDiseaseView();

  @override
  State<_AddHereditaryDiseaseView> createState() =>
      _AddHereditaryDiseaseViewState();
}

class _AddHereditaryDiseaseViewState extends State<_AddHereditaryDiseaseView> {
  final HereditaryDiseaseFormManager _formManager =
      HereditaryDiseaseFormManager();
  ...
  void initState() {
    ...
    context
        ...
        .setMedicalHistoryType(MedicalHistoryType.hereditary.index);
  }
  ...
  void _submitForm() {
    if (_formManager.validateForm()) {
      final record = HistoryRecordEntity(
        ...
        lastTimeDiagnosed: _formManager.lastTimeDiagnosedController.value,
        familyInfectionSpreadLevel:
            _formManager.familyInfectionSpreadLevelController.value,
                      ...
                      children: [
                        ...
                        CustomTextFormField(
                          ...
                          controller: _formManager
                              .lastTimeDiagnosedController.controller,
                          textInputAction: TextInputAction.next,
                        ),
                        verticalSpace(16),
                        CustomTextFormField(
                          ...
                          controller: _formManager
                              .familyInfectionSpreadLevelController.controller,
                          textInputAction: TextInputAction.next,
                        ),
                        verticalSpace(16),
                        CustomTextFormField(
