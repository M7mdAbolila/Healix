...
class _ChatbotApiService implements ChatbotApiService {
  ...
  @override
  Future<GetAllChatsResponseModel> getAllChats() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GetAllChatsResponseModel>(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late GetAllChatsResponseModel _value;
    try {
      _value = GetAllChatsResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
