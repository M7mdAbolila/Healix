...
class $AssetsLottiesGen {
  ...
  /// File path: assets/lotties/healix loading.json
  LottieGenImage get healixLoading =>
      const LottieGenImage('assets/lotties/healix loading.json');

  /// List of all assets
  List<LottieGenImage> get values => [healixLoading];
}
